                ...
                <div class="co-12 mt-30">
                  <a href="shop-grid.html" class="catagory-single home3cat">
                    ...
                    <div class="content">
                      <div class="row w-100 h-100 align-items-center">
                        <div class="col-12">
                          <h5 class="wow animated red fadeInUp" data-wow-delay="0.2s">
                            20% Off
                          </h5>
                          <h3 class="wow animated fadeInUp" data-wow-delay="0.3s">
                            Men Sneakers
          ...
          <div class="row">
            <div class="col-12">
              <ul class="nav three nav-pills justify-content-center" id="pills-tab-two" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-top-rated-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-top-rated" type="button" role="tab" aria-controls="pills-top-rated"
                    aria-selected="false">
                    Top Rated
                  </button>
                </li>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">High Quality Sneakers
                          </a>
                        </h5>
                        <p>$159.00</p>
                      </div>
          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6 wow fadeInLeft animated">
              <div class="video-main-box position-relative">
                <div class="video-two__img" style="
                        background-image: url(src/assets/images/home-three/video-v2-img1.jpg);
                      ">
                  <div class="icon wow zoomIn animated animated" data-wow-delay="300ms" data-wow-duration="1500ms" style="
                          visibility: visible;
              ...
              <div class="video-two__content">
                <div class="video-two__content-inner">
                  ...
                  <div class="btn-box wow fadeInUp animated">
                    <a href="shop-grid.html" class="btn--primary style2">Discover More</a>
                  </div>
                </div>
              </div>
            </div>
                              ...
                              <div class="tabs">
                                <div class="popup-product-thumb-box">
                                  <ul>
                                    ...
                                    <li class="tab-nav popup-product-thumb">
                                      <a href="#tabb33">
                                        <img src="src/assets/images/shop/products-v6-img8.jpg" alt="" />
                                      </a>
                                    </li>
                                  </ul>
                                </div>
                                ...
                                <div class="tabs">
                                  <div class="popup-product-thumb-box">
                                    <ul>
                                      ...
                                      <li class="tab-nav popup-product-thumb">
                                        <a href="#tabb333">
                                          <img src="src/assets/images/shop/products-v6-img9.jpg" alt="" />
                                        </a>
                                      </li>
                                    </ul>
                                  </div>
                              ...
                              <div class="tabs">
                                <div class="popup-product-thumb-box">
                                  <ul>
                                    ...
                                    <li class="tab-nav popup-product-thumb">
                                      <a href="#tabb3333">
                                        <img src="src/assets/images/shop/products-v6-img10.jpg" alt="" />
                                      </a>
                                    </li>
                                  </ul>
                                </div>
                              ...
                              <div class="tabs">
                                <div class="popup-product-thumb-box">
                                  <ul>
                                    <li class="tab-nav popup-product-thumb">
                                      <a href="#tab1">
                                        <img src="src/assets/images/shop/products-v6-img1.jpg" alt="" />
                                      </a>
                                    </li>
                                    <li class="tab-nav popup-product-thumb">
                                      <a href="#tab2">
                                        <img src="src/assets/images/shop/products-v6-img2.jpg" alt="" />
                                      </a>
                                    </li>
                                    <li class="tab-nav popup-product-thumb">
                                      <a href="#tab3">
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-md-6 wow fadeInUp animated">
                <div class="products-cetagory-three__single">
                  <div class="products-cetagory-three__single-img height-400" style="
                      ...
                      <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                        <div class="categories-three__list-item-inner">
                          ...
                          <div class="title text-center">
                            <h4>
                              <a href="shop-grid-left-sidebar.html">Sport’s Shoes</a>
                            </h4>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                      <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                        <div class="categories-three__list-item-inner">
                          ...
                          <div class="title text-center">
                            <h4>
                              <a href="shop-grid-left-sidebar.html">Casual Shoes</a>
                            </h4>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                      <div class="categories-three__list-item mt-30 wow fadeInUp animated">
                        <div class="categories-three__list-item-inner">
                          ...
                          <div class="title text-center">
                            <h4>
                              <a href="shop-grid-left-sidebar.html">Office Shoes</a>
                            </h4>
                          </div>
                        </div>
                      </div>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
              <div class="blog-three__single mt-30">
                ...
                <div class="blog-three__single-content text-center">
                  ...
                  <h4>
                    <a href="blog-single.html">A Perfect Style With Our Fashion Shoes</a>
                  </h4>
                  <div class="btn-box">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
              <div class="blog-three__single mt-30">
                ...
                <div class="blog-three__single-content text-center">
                  <span>Vendora Style</span>
                  <h4>
                    <a href="blog-single.html">2021-2021 fall-winter men's shoe trends.</a>
                  </h4>
                  <div class="btn-box">
                    <a href="blog-single.html">Read More</a>
                  </div>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
              <div class="blog-three__single mt-30">
                ...
                <div class="blog-three__single-content text-center">
                  <span>Vendora Style</span>
                  <h4>
                    <a href="blog-single.html">What men's shoes will be in fashion in the spring
                    </a>
                  </h4>
                  <div class="btn-box">
                    <a href="blog-single.html">Read More</a>
